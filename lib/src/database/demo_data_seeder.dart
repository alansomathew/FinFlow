      ...
      await db
          ...
          .insert(
            SmsInboxCompanion.insert(
              id: uuid.v4(),
              messageBody:
                  'Alert: Rs 1,850.00 debited from HDFC A/c xx8712 to SWIGGY. Ref 61502939. Bal: Rs 52,350.00',
              sender: 'AD-HDFCBK',
      ...
      await db
          ...
          .insert(
            SmsInboxCompanion.insert(
              id: uuid.v4(),
              messageBody:
                  'Dear Customer, SBI A/c xx5678 debited by Rs 500.00 via UPI to RAJESH STORES. Ref 61503120.',
              sender: 'HP-SBIPG',
      ...
      await db
          ...
          .insert(
            SmsInboxCompanion.insert(
              id: uuid.v4(),
              messageBody:
                  'ICICI Bank Card xx2001 debited by Rs 2,450.00 at AMAZON INDIA on 29-May-2026. Limit Avail: Rs 1,35,100.',
              sender: 'AD-ICICIBK',
